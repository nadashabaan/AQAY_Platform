...
import SUM from "../assets/Images/SUM.png"; // Ensure path is correct
...
function SignUpFormM() {
  ...
  const [formData, setFormData] = useState({
    ...
    nationalId: "",
    dateOfBirth: "", // Adding date of birth state
    userType: "",
  });
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(
          data.message ||
            "keep an eye on Your Email .. your account is being validated."
        );
        navigate("/SignIn");
      } else {
        throw new Error(
    ...
    <div className="container">
      <div className="left-section">
        ...
        <p>
          ...
          showcase your passion to the world!
        </p>
        <Link to="/SignUpM">
